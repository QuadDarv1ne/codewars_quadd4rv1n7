...
def decode_morse(morse_code):
    ...
    # Разделяем строку на слова (разделитель — 3 пробела)
    words = morse_code.split('   ')
    
    # Декодируем каждое слово
    decoded_message = []
    for word in words:
        # Разделяем слово на символы (разделитель — 1 пробел)
        characters = word.split(' ')
        # Декодируем каждый символ с использованием словаря MORSE_CODE
